...
- serverless 네트워크: NCC(binding, private endpoint rule), network policy. account 레벨 객체지만 `envs/<env>/platform`에서 관리
...
account/               계정 전역. metastore, account SP, entitlement
